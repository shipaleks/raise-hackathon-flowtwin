...
3. **Intake & Signals** — arrival mode (walk-in / ambulance / referral), a **vocal-biomarker screening** result from the reception conversation shown as *non-diagnostic risk flags* ("Screening signal — not a diagnosis"), optional **wearable / fitness-tracker** data (HR, HRV, overnight arrhythmia flag), and a note on how those signals shifted the prediction.
