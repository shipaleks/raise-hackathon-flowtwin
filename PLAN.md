...
- **Intake signals:** at reception, a passive **vocal-biomarker screening** (non-diagnostic risk flags) + optional **wearable/fitness-tracker** data enrich the incoming agent and can suggest an operational step earlier. On-prem, ops-gated, labelled "screening — not a diagnosis". Real research direction (Klick Labs diabetes-from-voice 2023; Sonde/Canary/Vocalis) — exact citation **TO VERIFY** (DESIGN §8/§14).
...
- **Intake & signals** — a new patient greets reception → vocal-biomarker "listening" → a screening flag + wearable data populate their Intake tab and nudge the prediction. Slots before or parallel to the Live Translate stretch.
