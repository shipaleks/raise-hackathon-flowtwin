...
/** The safety badge: every outbound recommendation is topic-gated to operations. */
export function OpsOnlyBadge() {
  return (
    <span
      className="chip chip--guard"
      title="NemoGuard topic control: operational logistics only — never diagnosis, treatment, or medication advice."
    >
